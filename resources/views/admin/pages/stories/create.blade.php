...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> {{__('dashboard.crud.add')}}/</span> {{__('dashboard.story.story')}}</h4>
        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">{{__('dashboard.crud.add')}}  {{__('dashboard.story.story')}}</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{route('admin.story.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" class="form-control" id="name_ar" value="{{old('title_ar')}}" placeholder="{{__('dashboard.table.name_ar')}}" name="title_ar" />
                            </div>
