...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><a href="{{route('admin.contact.index')}}"><span class="text-muted fw-light"> {{__('dashboard.sections.OurContact')}}/</span></a> {{__('dashboard.crud.edit')}}</h4>
