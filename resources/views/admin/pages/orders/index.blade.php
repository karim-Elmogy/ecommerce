                        ...
                        <table class="table" >
                            ...
                            @foreach ($payments as $payment)
                                <tr class="text-center">
                                    ...
                                    @endif
                                    @if($payment->app_id)
                                        <td>{{ @$payment->app->university->name }}</td>
                                        <td>{{ @$payment->app->package->name }}</td>
                                    @else
                                        <td>{{ @$payment->un_app->university->name }}</td>
                                        <td>{{ @$payment->un_app->specialization->name }}</td>
                                    @endif
                                    ...
                                    <td class="d-flex flex-direction-row ">
                                        ...
                                        <a href="{{route('admin.order.show',$payment->id)}}" class="btn btn-warning me-2">
