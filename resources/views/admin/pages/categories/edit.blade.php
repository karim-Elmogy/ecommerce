...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{__('dashboard.crud.edit')}}/</span>  {{__('dashboard.category.category')}} </h4>
        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"> {{__('dashboard.crud.edit')}} {{__('dashboard.category.category')}} </h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{route('admin.category.update',$city->id)}}"
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                @if($city->image)
                                    <img src="{{url('/dash-img/category/'.$city->image)}}" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar"/>
                                @else
                        ...
                        <div class="row">
                            <div class="mb-3 col-12">
                                ...
                                <textarea class="form-control editor"  rows="12" id="desc_ar" name="desc_ar">{{$city->desc_ar}}</textarea>
                            </div>

                            <div class="mb-3 col-12">
                                <label class="form-label" for="desc_en">{{__('dashboard.table.desc_en')}} </label>
                                <textarea class="form-control editor" id="desc_en" name="desc_en">{{$city->desc_ar}}</textarea>
                            </div>
                        </div>
