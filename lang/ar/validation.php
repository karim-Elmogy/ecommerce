...
return [
    ...
    */
    ...
    'dimensions' => 'الأبعاد غير صالحة لـ :attribute.',
    ...
    'max' => [
        ...
        'string' => 'يجب ألا يتجاوز :attribute عدد الحروف :max.',
    ...
    'timezone' => 'يجب أن يكون :attribute مدة زمنية صحيحة.',
    ...
    /*
    |--------------------------------------------------------------------------
    | رسائل التحقق المخصصة باللغة
    |--------------------------------------------------------------------------
    |
    | يمكنك هنا تحديد رسائل التحقق المخصصة للسمات باستخدام
    | الاتفاقية "attribute.rule" لتسمية السطور. هذا يسهل
    | تحديد رسالة لغوية مخصصة معينة لقاعدة سمة معينة.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | تُستخدم السطور اللغوية التالية لتبديل بيانات السمة الخاصة بنا
    | بشيء أكثر ودية للقارئ مثل "عنوان البريد الإلكتروني" بدلاً من "email". هذا ببساطة يساعدنا على جعل رسائلنا أكثر تعبيرًا.
    |
    */
